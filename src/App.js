...
function PackingList({ items, onDeleteItem, onToglleItem, onClearList }) {
...
function Item({ item, onDeleteItem, onToglleItem }) {
  return (
    <li>
      <input
        type="checkbox"
